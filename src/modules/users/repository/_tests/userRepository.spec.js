...
let mockDataBase;
const userData = {id: 1, name:'John', surname:'Doe', age:'30', phone:5551234, email:'john.doe@example.com', document:12345678}
...
test('it test editUser', ()=>{
    ...
    const updatedUser = {id: 1, name:'Juan', surname:'Dos', age:'31', phone:5551234, email:'john.doe@example.com', document:12345678};
...
test('it test getAllUsers', ()=>{
    const userRepository = new UserRepository(mockDataBase);
    userRepository.createUser(userData);
    userRepository.createUser({id: 2, name:'Juan', surname:'Dos', age:'31', phone:5551234, email:'john.doe@example.com', document:12345678});
    const users = userRepository.getAllUsers();
    expect(users).toEqual([userData, {id: 2, name:'Juan', surname:'Dos', age:'31', phone:5551234, email:'john.doe@example.com',document:12345678}]);
