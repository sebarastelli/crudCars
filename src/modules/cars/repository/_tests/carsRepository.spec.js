...
const carData2={brand:"toyota2",model:"hilux2",year:2022,kms:15000,color:"red",ac:"yes",passengers:6,transmission:"manual",picture:"",price:150};
...
test('it test getAllCars', ()=>{
    ...
    expect(cars).toEqual([{id:1, ...carData},{id:2, ...carData2}]);
})